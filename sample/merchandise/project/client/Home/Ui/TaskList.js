...
class TaskList extends _reactiveWidget.Widget {
  render() {
    const items = [];
    ...
    for (let i = 0; i < 10; i++) {
      items.push( /*#__PURE__*/React.createElement("div", {
        key: i
      }, "Task #", i, ":", ' ', /*#__PURE__*/React.createElement(_reactiveWidget.ErrorBoundary, {
        fallback: /*#__PURE__*/React.createElement("span", null, "\u7B97\u9519\u4E86")
      }, /*#__PURE__*/React.createElement(React.Suspense, {
        fallback: /*#__PURE__*/React.createElement("span", null, "\u8BA1\u7B97\u4E2D...")
      }, (0, _reactiveWidget.renderWidget)(_TaskListItem.TaskListItem)))));
    }
